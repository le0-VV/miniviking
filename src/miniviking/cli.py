...
from .config import CONFIG_PATH, DEFAULT_HOST, DEFAULT_PORT, RuntimeMode, config_from_defaults, load_config, write_config
...
def main(argv: list[str] | None = None) -> None:
    ...
    except (DownloadError, HostDetectionError, OSError, RuntimeError, ValueError) as exc:
